...
export const APP_TITLE = "Premium Meet and Greet Services";
...
export const OFFICE_ADDRESS_LINE_1 = process.env.NEXT_PUBLIC_OFFICE_ADDRESS_LINE_1 || "8 Spout Lane North";
export const OFFICE_ADDRESS_LINE_2 = process.env.NEXT_PUBLIC_OFFICE_ADDRESS_LINE_2 || "Heathrow";
export const OFFICE_ADDRESS_LINE_3 = process.env.NEXT_PUBLIC_OFFICE_ADDRESS_LINE_3 || "London, TW19 6BW";

export const OWNER_DEFAULT_NOTIFICATION_EMAIL = "desk.vipfirst@gmail.com";

export const WEBSITE_URL = process.env.NEXT_PUBLIC_BASE_URL || "https://vipgreeters.co.uk";
